...
class SupermarketServiceTest {
    ...
    void testComputeCheckout_WithSingleOffer() {
        ...
        Offer offer = new Offer(1L, 2, BigDecimal.valueOf(45), null); // 2 for 45
    ...
    void testComputeCheckout_WithMultipleOffers() {
        ...
        Offer offer1 = new Offer(1L, 3, BigDecimal.valueOf(60), null); // 3 for 60 for apples
        Offer offer2 = new Offer(2L, 2, BigDecimal.valueOf(45), null); // 2 for 45 for apples
        Offer offer3 = new Offer(3L, 2, BigDecimal.valueOf(80), null); // 2 for 80 for bananas
        apple.setOffers(new ArrayList<>(List.of(offer1, offer2)));
        banana.setOffers(new ArrayList<>(List.of(offer3)));
